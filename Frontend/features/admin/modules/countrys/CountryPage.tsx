...
const countryService = {
    getAll: async (params: CountrySearchParams) => {
        // Mock API call
        await new Promise(resolve => setTimeout(resolve, 500));

        const mockData: Country[] = [
            { _id: "1", name: "México", isActive: true, createdAt: "2025-06-17T10:00:00Z" },
            { _id: "2", name: "Estados Unidos", isActive: true, createdAt: "2025-06-17T10:00:00Z" },
            { _id: "3", name: "Canadá", isActive: false, createdAt: "2025-06-17T10:00:00Z" },
        ];
...
const CountryPage: React.FC = () => {
    ...
    const loadCountries = useCallback(async (isInitial: boolean, params?: Partial<CountrySearchParams>) => {
        try {
            if (isInitial) {
                setLoading(true);
            }
            ...
            const response = await countryService.getAll(searchParams);
                                    ...
                                    <Table className="table table-custom table-centered table-select table-hover w-100 mb-0" style={{ tableLayout: "fixed" }}>
                                        <thead className="bg-light align-middle bg-opacity-25 thead-sm">
                                            <tr>
                                                ...
                                                <th className="text-center" style={{ width: "50%" }}>PAÍS</th>
