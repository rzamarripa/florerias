                  ...
                  <div className="card-body">
                    <div className="auth-brand text-center mb-4">
                      ...
                      <h4 className="fw-bold mt-4">
                        Request sent Successfully ! | IN+
                      </h4>
                    </div>

                    <div className="text-center mb-4">
                      <h5 className="text-muted fs-base mb-3">
                        We&apos;ve emailed you a 6-digit verification code we
                        sent to
                      </h5>
                    ...
                    <p className="mt-4 text-muted text-center mb-4">
                      ...
                      <Link
                        href=""
                        className="text-decoration-underline link-offset-2 fw-semibold"
                      >
                        Resend
                      </Link>{" "}
                      or{" "}
